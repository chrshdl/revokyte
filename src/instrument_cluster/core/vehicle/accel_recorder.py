"""Full-throttle acceleration run capture, for measuring the engine curve.

Everything the shift point depends on is the *shape* of the power curve
past the peak, and every number the model has for that shape is a prior:
...
class AccelRunRecorder:
    ...
    # -- live progress, for a caller that shows it --
    ...
    # The save gates, re-exported so a caller can show live progress
